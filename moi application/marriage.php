...
<div class="form-container">
        <h2><i class="fa fa-heart" aria-hidden="true"></i> <span class="form-title">Wedding Details</span></h2>
        <form action="marriage_submit.php" method="post">
            <div class="form-section">
                <div class="form-group">
                    <label for="swaminame"><i class="fa fa-user" aria-hidden="true"></i> <span class="swamiName">Swami Name</span></label>
                    <input type="text" id="swaminame" name="swaminame" placeholder="Enter the swami name">
                    <div id="swaminameError" class="error"></div>
                </div>
                <div class="form-group">
                    <label for="the_groom"><i class="fa fa-male" aria-hidden="true"></i> <span class="groomName">Groom (Name)</span></label>
                    <input type="text" id="the_groom" name="the_groom" placeholder="Enter groom's name" required>
                    <div id="groomError" class="error"></div>
                </div>
                <div class="form-group">
                    <label for="the_bride"><i class="fa fa-female" aria-hidden="true"></i> <span class="brideName">Bride (Name)</span></label>
                    <input type="text" id="the_bride" name="the_bride" placeholder="Enter bride's name" required>
                    <div id="brideError" class="error"></div>
                </div>
                <div class="form-group">
                    <label for="date"><i class="fa fa-calendar" aria-hidden="true"></i> <span class="dateLabel">Date</span></label>
            ...
            <div class="form-section">
                <div class="form-group">
                    <label for="mahal"><i class="fa fa-building" aria-hidden="true"></i> <span class="mahalLabel">Mahal</span></label>
                    <input type="text" id="mahal" name="mahal" placeholder="Enter mahal">
                </div>
                <div class="form-group">
                    <label for="place"><i class="fa fa-map-marker" aria-hidden="true"></i> <span class="placeLabel">Place</span></label>
                    <input type="text" id="place" name="place" placeholder="Enter place">
                </div>
                <div class="form-group">
                    <label for="timing"><i class="fa fa-clock" aria-hidden="true"></i> <span class="timingLabel">Timing</span></label>
                    <input type="text" id="timing" name="timing" placeholder="Enter timing">
                </div>
            </div>
...
document.getElementById('toggleBtn').addEventListener('click', () => {
        ...
        window.onload = function() {
            ...
            document.getElementById('timing').value = `${hours}:${minutes}`;
        };
    </script>
