...
<form action="maternaluncle_submit.php" method="post">
            <!-- Date Section -->
            <div class="form-section">
                <div class="mb-3">
                <h2 class="mb-4"><i class="fa fa-plus-square" aria-hidden="true"></i>Add Maternal Uncle Moi</h2>
            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <div class="form-section">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="swaminame" class="form-label"><i class="fas fa-user form-icon"></i>Swami Name</label>
                                <input type="text" id="swaminame" name="swaminame" class="form-control" value="<?php echo htmlspecialchars($row['swaminame']); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="the_groom" class="form-label"><i class="fas fa-male form-icon"></i>Marriage Groom (Name)</label>
                                <input type="text" id="the_groom" name="the_groom" class="form-control" value="<?php echo htmlspecialchars($row['the_groom']); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="the_bride" class="form-label"><i class="fas fa-female form-icon"></i>Marriage Bride (Name)</label>
                                <input type="text" id="the_bride" name="the_bride" class="form-control" value="<?php echo htmlspecialchars($row['the_bride']); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="mahal" class="form-label"><i class="fas fa-building form-icon"></i>Mahal</label>
                                <input type="text" id="mahal" name="mahal" class="form-control" value="<?php echo htmlspecialchars($row['mahal']); ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Marriage Type Section -->
            <div class="form-section">
                <div class="mb-3">
                    <label class="form-label"><i class="fas fa-heart form-icon"></i>Marriage Type</label>
                    <div class="form-check">
                        <input type="checkbox" id="marriage-boy" name="marriage_type" value="boy" class="form-check-input">
                        <label for="marriage-boy" class="form-check-label">The Groom</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" id="marriage-girl" name="marriage_type" value="girl" class="form-check-input">
                        <label for="marriage-girl" class="form-check-label">The Bride</label>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="tel" id="mobile" name="mobile" class="form-control" placeholder="Please enter a 10-digit mobile number" pattern="\d{10}" maxlength="10" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
            ...
            <div class="form-section">
                <div class="mb-3">
                    ...
                    <select id="sequence" name="sequence" class="form-select" required>
                        ...
                        <option value="thambalam">Thambalam</option>
            ...
            <div class="form-section extra-text-box" id="extraTextBox">
                <div class="mb-3">
                    ...
                    <input type="text" id="extraInput" name="extra_input" class="form-control" placeholder="Enter additional information">
                </div>
            </div>
