...
<?php
include('db.php');
$sql = "SELECT * FROM uncle ORDER BY date DESC";
...
<head>
    ...
    <title>list Maternal uncle Dashboard</title>
...
?>
<div class="container">
    <form method="POST" action="maternaluncle_delete_record.php">
            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php while($row = $result->fetch_assoc()): ?>
                    ...
                    <td><?= htmlspecialchars($sno++); ?></td>
                        ...
                        <td><?php echo htmlspecialchars($row['marriage_type']); ?></td>
                        <td><?php echo htmlspecialchars($row['name']); ?></td>
                        <td><?php echo htmlspecialchars($row['address']); ?></td>
                        <td><?php echo htmlspecialchars($row['mobile']); ?></td>
                        <td><?php echo htmlspecialchars($row['sequence']); ?></td>
                        <td><?php echo htmlspecialchars($row['extra_input']); ?></td>
                        <td><?php echo htmlspecialchars($row['amount']); ?></td>
                        <td class="actions">
                            <a href="maternaluncle_edit.php?id=<?php echo htmlspecialchars($row['id']); ?>" title="Edit"><i class="fas fa-edit"></i></a>
                            <a href="maternaluncle_view.php?id=<?php echo htmlspecialchars($row['id']); ?>" title="View"><i class="fas fa-eye"></i></a>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generatePDF() {
       ...
       // Calculate column widths based on content
        ...
        let currentY = 25;
        const cellPadding = 2;
        const columnWidths = headers.map(header => Math.max(header.length * 2.6, 25));
...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = `maternaluncle_delete.php?id=${id}`;
        }
    });
}
