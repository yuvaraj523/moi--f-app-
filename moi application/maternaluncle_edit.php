...
if (!isset($_SESSION['username'])) {
 ...
 if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql = "SELECT * FROM uncle WHERE id='$id'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE uncle SET date='$date', the_groom='$the_groom', the_bride='$the_bride', marriage_type='$marriage_type', name='$name', address='$address', mobile='$mobile',sequence='$sequence',extra_input='$extra_input', amount='$amount' WHERE id='$id'";

    if ($con->query($updateSql) === TRUE) {
        $_SESSION['success_message'] = 'Record updated successfully!';
        header("Location:maternaluncledisplay.php?message=update_success");
        exit;
    } else {
...
<form id="marriageForm" action="maternaluncle_edit.php?id=<?php echo htmlspecialchars($id); ?>" method="post">
<!-- Hidden field to store the ID of the record -->
<?php if ($id): ?>
...
<div class="form-section">
    <div class="mb-3">
        <h2 class="mb-4"><?php echo $id ? 'Edit Maternal Uncle Moi' : 'Add Maternal Uncle Moi'; ?></h2>
...
<div class="form-section">
    <div class="mb-3">
        ...
        <div class="form-check">
            <input type="checkbox" id="marriage-boy" name="marriage_type[]" value="boy" class="form-check-input" <?php echo isset($row) && in_array('boy', explode(',', $row['marriage_type'])) ? 'checked' : ''; ?>>
            <label for="marriage-boy" class="form-check-label">The Groom</label>
        </div>
        <div class="form-check">
            <input type="checkbox" id="marriage-girl" name="marriage_type[]" value="girl" class="form-check-input" <?php echo isset($row) && in_array('girl', explode(',', $row['marriage_type'])) ? 'checked' : ''; ?>>
    ...
    <div class="form-section">
        ...
        <a href="maternaluncledisplay.php" class="btn btn-secondary">Cancel</a>
    </div>
</form>
