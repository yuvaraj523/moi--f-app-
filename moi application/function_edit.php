...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE ceremony SET swaminame='$swaminame', date='$date', ceremony='$ceremony', ceremonyowner='$ceremonyowner', mahal='$mahal', place='$place', timing='$timing' WHERE id='$id'";

    if ($con->query($updateSql) === TRUE) {
        $_SESSION['success_message'] = 'Record updated successfully!';
        header("Location: functiondisplay.php?message=update_success");
        exit;
    } else {
...
<head>
    ...
    <title>Marriage Edit Details</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <h2>  <i class="fa fa-edit" aria-hidden="true"></i> Edit Ceremony Details</h2>
        <form id="functionForm" action="function_edit.php?id=<?php echo htmlspecialchars($id); ?>" method="post">
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <input type="text" id="swaminame" name="swaminame" value="<?php echo htmlspecialchars($swaminame); ?>" required>
                </div>
            ...
            <div class="form-section">
    <div class="form-group">
                    <label for="ceremony"><i class="fa fa-check-square" aria-hidden="true"></i> Choose Ceremony</label>
                    <select id="ceremony" name="ceremony" required>
                        <option value="" disabled>Select one</option>
                        <option value="spring ceremony" <?php echo $ceremony === 'spring ceremony' ? 'selected' : ''; ?>>Spring ceremony</option>
                        <option value="earring ceremony" <?php echo $ceremony === 'earring ceremony' ? 'selected' : ''; ?>>Earring ceremony</option>
                        <option value="housewarming ceremony" <?php echo $ceremony === 'housewarming ceremony' ? 'selected' : ''; ?>>Housewarming ceremony</option>
                    </select>
                </div>
    
                <div class="form-group">
                    <label for="ceremonyowner"><i class="fa fa-users" aria-hidden="true"></i> Ceremony Owner</label>
                    <input type="text" id="ceremonyowner" name="ceremonyowner" value="<?php echo htmlspecialchars($ceremonyowner); ?>" placeholder="Enter ceremony owner name" required>
                </div>
    
                <div class="form-group">
                    <label for="mahal"><i class="fa fa-building" aria-hidden="true"></i> Mahal</label>
                    <input type="text" id="mahal" name="mahal" value="<?php echo htmlspecialchars($mahal); ?>" placeholder="Enter mahal">
                </div>
    
                <div class="form-group">
                    <label for="place"><i class="fa fa-map-marker" aria-hidden="true"></i> Place</label>
                    <input type="text" id="place" name="place" value="<?php echo htmlspecialchars($place); ?>" placeholder="Enter place">
                </div>
    
                <div class="form-group">
                    <label for="timing"><i class="fa fa-clock" aria-hidden="true"></i> Timing</label>
                    <input type="text" id="timing" name="timing" value="<?php echo htmlspecialchars($hours . ':' . $minutes . ' ' . $ampm); ?>" placeholder="Enter timing">
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="functiondisplay.php" class="cancel-btn">Cancel</a>
            </div>
        </form>
    </div>
