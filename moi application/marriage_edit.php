...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE wedding SET swaminame='$swaminame', date='$date', the_groom='$the_groom', the_bride='$the_bride', mahal='$mahal', place='$place', timing='$timing' WHERE id='$id'";

if ($con->query($updateSql) === TRUE) {
        $_SESSION['success_message'] = 'Record updated successfully!';
        header("Location: marriagedisplay.php?message=update_success");
        exit;
    } else {
...
<div class="form-container">
   <h2>Edit wedding Detail</h2>
     <form id="marriage" action="marriage_edit.php?id=<?php echo htmlspecialchars($id); ?>" method="post">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="the_groom" name="the_groom" value="<?php echo htmlspecialchars($the_groom); ?>" placeholder="Enter groom's name" required>
                </div>
                <div class="form-group">
                    <label for="the_bride"><i class="fa fa-female" aria-hidden="true"></i> Bride (Name)</label>
                    <input type="text" id="the_bride" name="the_bride" value="<?php echo htmlspecialchars($the_bride); ?>" placeholder="Enter bride's name" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-actions">
                ...
                <a href="marriagedisplay.php" class="cancel-btn">Cancel</a>
            </div>
        </form>
      </div>
</div>
